...
public class ServiceReclamation implements IService<Reclamation>{
    ...
    public void add(Reclamation r) throws SQLException {
        String sql = "INSERT INTO `Reclamation` (`id`, `dateReclamation`, `objet`, `description` , `etat`) VALUES (NULL, '"+r.getDateReclamation()+"', '"+r.getObjet()+"', '"+r.getDescription()+"', '"+r.getEtat()+"');  ";
    ...
    public ArrayList readAll() throws SQLException {
        ...
        try {
            ...
            while (res.next()) {
                ...
                Date dateReclamation = (res.getDate(2));
    ...
    public Reclamation get(int id) throws SQLException {
        ...
        if (res.next()) {
            Date dateReclamation = res.getDate("dateReclamation");
